...
public final class FragmentEditAccountInfoBinding implements ViewBinding {
  ...
  @NonNull
  public final LinearLayout toolbarEditProfile;
  ...
  private FragmentEditAccountInfoBinding(@NonNull NestedScrollView rootView,
      ...
      @NonNull LinearLayout toolbarEditProfile, @NonNull TextView tvChangePass) {
  ...
  public static FragmentEditAccountInfoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      LinearLayout toolbarEditProfile = ViewBindings.findChildViewById(rootView, id);
      ...
      return new FragmentEditAccountInfoBinding((NestedScrollView) rootView, btnSave, editEmail,
          editPassword, editPhone, guideline1, guideline2, imvUserAvatar, lyEmail, lyPass, lyPhone,
          toolbarEditProfile, tvChangePass);
    }
